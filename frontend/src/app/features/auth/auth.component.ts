...
export class AuthComponent implements OnInit, AfterViewInit {
  ...
  private handleLogin(): void {
    ...
    this.authService
      .login(cleanEmail, password, this.currentRole)
      .subscribe({
  ...
  private handleRegister(): void {
    ...
    if (this.currentRole === 'patient') {
      ...
      payload.specialization = Array.from(
  ...
  private initGoogleAuth(): void {
    ...
    if (typeof google === 'undefined') {
      const existingScript =
        this.document.getElementById('google-jssdk');
        ...
        google.accounts.id.renderButton(host, {
          ...
          text:
            this.currentIntent === 'login'
              ...
              : 'signup_with',
          logo_alignment: 'left',
          width: host.parentElement?.clientWidth
            ? Math.min(
